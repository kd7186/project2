...
<body>
	...
	<form action="/replyaction" method="post" enctype="multipart/form-data">
		<input type="hidden" name="bId" value="${reply.bId }">
		<input type="hidden" name="bGroup" value="${reply.bGroup }">
		<input type="hidden" name="bOrder" value="${reply.bOrder }">
		<input type="hidden" name="bDepth" value="${reply.bDepth }">
		<table>
			<tr>
				<td><input type="text" name="bTitle" placeholder="제목을 입력하세요" required id = "title" />
				</td>
			</tr>
			<tr>
